...
public class ApplicationTestIntegr {
  ...
  public void insertOne_json() throws Exception {
    String newPost1 = getResource("post1ToCreate.json");
    ...
    String expectedResponsePost1 = getResource("post1.json");
    mockMvc.perform(get("/posts/1")
        .headers(getJsonHeaders()))
        .andExpect(status().isOk())
        .andExpect(content().string(expectedResponsePost1));
  }

  @Test
  public void insertOneInvalid_json() throws Exception {
  ...
  public void insertTwo_json() throws Exception {
    ...
    String newPost2 = getResource("post2ToCreate.json");
    mockMvc.perform(post("/posts")
        .content(newPost2)
        .headers(getJsonHeaders()))
        .andExpect(status().isCreated())
    ...
    String expectedResponsePost2 = getResource("post2.json");
    mockMvc.perform(get("/posts/2")
        .headers(getJsonHeaders()))
        .andExpect(status().isOk())
        .andExpect(content().string(expectedResponsePost2));
  ...
  public void insertThree_json() throws Exception {
    ...
    String newPost3 = getResource("post3ToCreate.json");
    mockMvc.perform(post("/posts")
        .content(newPost3)
        .headers(getJsonHeaders()))
        .andExpect(status().isCreated())
    ...
    String expectedResponsePost3 = getResource("post3.json");
    mockMvc.perform(get("/posts/3")
        .headers(getJsonHeaders()))
        .andExpect(status().isOk())
        .andExpect(content().string(expectedResponsePost3));
  ...
  @Test
  public void insertThreeDeleteLast_json() throws Exception {
    String newPost1 = getResource("post1ToCreate.json");
    mockMvc.perform(post("/posts")
        .content(newPost1)
        .headers(getJsonHeaders()))
  ...
  public void insertOneAndUpdateFirst_json() throws Exception {
    ...
    String expectedUpdatedResponse = getResource("getAllPostsWith1PostFirstUpdated.json");
    mockMvc.perform(get("/posts")
        .headers(getJsonHeaders()))
        .andExpect(status().isOk())
        .andExpect(content().string(expectedUpdatedResponse));
  }
  ...
  @Test
  public void insertTwoRequestThird_json() throws Exception {
    String newPost1 = getResource("post1ToCreate.json");
    mockMvc.perform(post("/posts")
        .content(newPost1)
        .headers(getJsonHeaders()))
  ...
  public void insertOne_xml() throws Exception {
    String newPost1 = getResource("post1ToCreate.xml");
    mockMvc.perform(post("/posts")
        .content(newPost1)
        .headers(getXmlHeaders()))
        .andExpect(status().isCreated())
    ...
    String expectedResponsePost1 = getResource("post1.xml");
    mockMvc.perform(get("/posts/1")
        .headers(getXmlHeaders()))
        .andExpect(status().isOk())
        .andExpect(content().string(expectedResponsePost1));
  ...
  @Test
  public void insertOneInvalid_xml() throws Exception {
  ...
  public void insertTwo_xml() throws Exception {
    ...
    String newPost2 = getResource("post2ToCreate.xml");
    mockMvc.perform(post("/posts")
        .content(newPost2)
        .headers(getXmlHeaders()))
        .andExpect(status().isCreated())
    ...
    String expectedResponsePost2 = getResource("post2.xml");
    mockMvc.perform(get("/posts/2")
        .headers(getXmlHeaders()))
        .andExpect(status().isOk())
        .andExpect(content().string(expectedResponsePost2));
  ...
  public void insertThree_xml() throws Exception {
    ...
    String newPost3 = getResource("post3ToCreate.xml");
    mockMvc.perform(post("/posts")
        .content(newPost3)
        .headers(getXmlHeaders()))
        .andExpect(status().isCreated())
    ...
    String expectedResponsePost3 = getResource("post3.xml");
    mockMvc.perform(get("/posts/3")
        .headers(getXmlHeaders()))
        .andExpect(status().isOk())
        .andExpect(content().string(expectedResponsePost3));
  ...
  @Test
  public void insertThreeDeleteLast_xml() throws Exception {
    String newPost1 = getResource("post1ToCreate.xml");
    mockMvc.perform(post("/posts")
        .content(newPost1)
        .headers(getXmlHeaders()))
  ...
  @Test
  public void insertTwoRequestThird_xml() throws Exception {
    String newPost1 = getResource("post1ToCreate.xml");
    mockMvc.perform(post("/posts")
        .content(newPost1)
        .headers(getXmlHeaders()))
